...
<tr>
          ...
          <td className="text-center align-middle"> {/*used to be align right */}
            
            <ButtonGroup>
            <Button size="sm" variant="primary" onClick={handleViewData}>View Patient Data</Button><Button size="sm" variant="danger" onClick={handleRemovePatient}>Remove Patient</Button>
            </ButtonGroup>
            </td>
        </tr>
    );
